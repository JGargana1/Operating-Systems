...
module TSOS {
    ...
    export class Kernel {
        ...
        public krnBootstrap() {      // Page 8. {
            ...
            // ... more?
            //
            _MemoryAccessor = new MemoryAccessor(new Memory());
        ...
        public krnOnCPUClockPulse() {
            ...
            */
            ...
            } else if (_Scheduler && _CPU.isExecuting) { // If there are no interrupts then run one CPU cycle if there is anything being processed.
                //_CPU.cycle();
